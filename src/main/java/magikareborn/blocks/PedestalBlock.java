...
import magikareborn.tileEntitySpecialRenderers.PedestalTESR;
...
public class PedestalBlock extends BaseBlock implements ITileEntityProvider {

    // Used for visuals only
    public static final IProperty<Boolean> IS_HANDLES = PropertyBool.create("is_handles");

    public PedestalBlock() {
        super("PedestalBlock", Material.ROCK, CreativeTabs.MISC);
