package magikareborn.tileEntitySpecialRenderers;

import magikareborn.blocks.PedestalBlock;
...
public class PedestalTESR extends TileEntitySpecialRenderer<PedestalTileEntity> {
    ...
    private void renderHandles(PedestalTileEntity te) {
        ...
        IBlockState state = ModBlocks.PEDESTAL_BLOCK.getDefaultState().withProperty(PedestalBlock.IS_HANDLES, true);
